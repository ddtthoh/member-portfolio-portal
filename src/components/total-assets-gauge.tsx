...
export function TotalAssetsGauge({
  ...
  useEffect(() => {
    if (!inView) return;
    const a0 = animate(0, sLen, { duration: 2.2, ease: [0.16, 1, 0.3, 1], onUpdate: setSDraw });
    const a1 = animate(0, cLen, { duration: 2.2, delay: 0.3, ease: [0.16, 1, 0.3, 1], onUpdate: setCDraw });
    const a2 = animate(0, eLen, { duration: 2.2, delay: 0.6, ease: [0.16, 1, 0.3, 1], onUpdate: setEDraw });
