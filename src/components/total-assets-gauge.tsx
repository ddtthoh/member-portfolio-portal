...
export function TotalAssetsGauge({
  ...
  useEffect(() => {
    ...
    const a1 = animate(0, cLen, { duration: 1.5, delay: 0, ease: [0.16, 1, 0.3, 1], onUpdate: setCDraw });
    const a2 = animate(0, eLen, { duration: 1.5, delay: 0, ease: [0.16, 1, 0.3, 1], onUpdate: setEDraw });
