...
const highlights = [
  {
    ...
    value: "1 – 31 July 2026",
  },
  {
    icon: MapPin,
    label: "Grand Launch",
    value: "Hilton Istanbul · 31 Jul",
  },
  {
    icon: Users,
    label: "Referral Reward",
    value: "Min. 2 new joiners",
  },
  {
    icon: Trophy,
    label: "Top Lucky Draw",
    value: "30K Staking · 365d",
  },
];
        ...
        <SpotlightCard className="liquid-glass overflow-hidden rounded-2xl">
          ...
          >
            <div className="flex h-full flex-col items-center justify-center gap-3 p-10 text-center text-sm text-muted-foreground">
              ...
              <p>
                Your browser can’t display the PDF inline. Use the download
                or open-in-new-tab buttons above.
              </p>
            </div>
          </object>
        </SpotlightCard>
        ...
        <div className="flex flex-col gap-3">
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs leading-relaxed text-gold/70">
                    {p.body}
                  </p>
                </div>
              </div>
          ...
          <SpotlightCard className="liquid-glass rounded-2xl p-4">
            ...
            <p className="mt-3 text-[11px] leading-relaxed text-gold/60">
              One member may claim one lucky-draw prize. Full terms are inside
              the brief.
            </p>
          </SpotlightCard>
        </div>
